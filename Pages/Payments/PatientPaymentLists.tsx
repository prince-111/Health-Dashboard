...
export const PatientPaymentLists = ({ item }: any) => (
  <View style={styles.invoiceCard}>
    ...
    <View>
      <View style={styles.detailRow}>
        ...
        <Text style={styles.detailValue}>{item.receiptNum}</Text>
      </View>
      <View style={styles.detailRow}>
...
export default PatientPaymentLists;

// import React from 'react'
// import { View, StyleSheet, Text, Image, TouchableOpacity } from "react-native";

// export const PatientPaymentLists = ({ item, handleOpenEditModal }: any) => (
//   <View style={styles.invoiceCard}>
//     <View style={styles.header}>
//       <View style={styles.headerLeft}>
//         <Text style={styles.invoiceNumber}>Invoice: #{item.invoiceNum}</Text>
